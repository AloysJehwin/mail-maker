      ...
      <div className="w-full max-w-sm">
        <div className="bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-6 sm:p-8">
          ...
          <p className="text-center text-gray-600 mb-8">
            Capture moments, send them instantly
          </p>

          {/* Sign In Button */}
          <button
            onClick={() => signIn("google")}
            className="w-full bg-white border-2 border-gray-200 hover:border-indigo-500 text-gray-800 font-semibold py-4 px-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-3 active:scale-95"
          >
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-start gap-3">
                ...
                <span>Add fun stickers to your photos</span>
              </div>
              <div className="flex items-start gap-3">
                ...
                <span>Receive photos instantly via email</span>
              </div>
            </div>
          </div>
        </div>
